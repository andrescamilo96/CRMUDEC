					        ...
					        <div class="col-md-12" style="">
						        <div class="form-group" style="position: static;">
						        	<label for="empresa">Descripción Cargo:</label>										
										<input readonly="true" type="textarea" class="form-control" name="descripcion" id="descripcion"  placeholder="" value="{{ $historialaboral->descripcion }}" />
						        </div>
					        </div>
					        <div class="col-md-6" style="">
						        <div class="form-group" style="position: static;">
					        ...
					        <div class="col-md-6" style="">
						        <div class="form-group" style="position: static;">
						        	<label for="cargo">Ciudad:</label>										
										<input readonly="true" type="textbox" class="form-control" name="ciudadempresa_id" id="ciudadempresa_id"  placeholder="" value="{{ $historialaboral->ciudadempresa_id }}" />
						        </div>
					        </div>
					        <div class="col-md-6" style="">
						        <div class="form-group" style="position: static;">
						        	<label for="cargo">Telefono Empresa:</label>										
										<input readonly="true" type="textbox" class="form-control" name="telefonoempresa" id="telefonoempresa"  placeholder="" value="{{ $historialaboral->telefonoempresa }}" />
						        </div>
					        </div>
					        <div class="col-md-6" style="">
						        <div class="form-group" style="position: static;">
						        	<label for="cargo">Años Laborados:</label>										
										<input readonly="true" type="textbox" class="form-control" name="anoslaborados" id="anoslaborados"  placeholder="" value="{{ $historialaboral->anoslaborados }}" />
						        </div>
					        </div>
